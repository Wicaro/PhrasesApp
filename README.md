...
- 👨‍💻 PhrasesApp made in **Flutter - Dart**.
- PhrasesApp is an application that was developed with the intention of practicing mobile development, basically it is an application that displays some random phrases that are inside an array
